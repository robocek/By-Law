...
\begin{figure}[!h]
	\centering
	\subfloat[Official Logo]{\includegraphics[width=0.3\textwidth]{Images/ROBOCEK_logo_black.png}}
	\quad
	\subfloat[Official Seal]{\includegraphics[width=0.25\textwidth]{Images/ROBOCEK round seal.png}}
\end{figure}
